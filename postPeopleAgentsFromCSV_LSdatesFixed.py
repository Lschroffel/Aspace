...
if secretsVersion != '':
    ...
    print('doent need to be so complicated')
    secrets = __import__('secrets2')
...
if targetFile != '':
    ...
    csvfile = csv.DictReader(open('agentsexpanded.csv'))
